...
class Simulator
{
	...
	string fname;
        ...
        Simulator(Network* net, string fname) { this->net = net; this->time = 0; this->mtrand = net->get_rng(), fname=fname; };
        Simulator(vector<Network*> net_list, string fname){this->net_list = net_list; this->time = 0; this->mtrand = net->get_rng(), this->fname=fname; };
